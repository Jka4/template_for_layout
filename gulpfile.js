...
gulp.task("sprite", function() {
  ...
  var imgStream = spriteData.img.pipe(gulp.dest("build/images/sprite"));
...
gulp.task("copy", function() {
  return gulp.src("src/files/**/*").pipe(gulp.dest("build/"));
});
...
gulp.task("clean", function() {
  del(".publish", { force: true });
});

gulp.task("deploing", function() {
...
gulp.task("deploy", function(done) {
  runSequence("deploing", "clean", function() {
    done();
  });
});
